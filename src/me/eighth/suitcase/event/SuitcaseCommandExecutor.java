	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (arguments.size() == 0 || aliases.get("help").contains(arguments.get(0))) {
			...
			if (plugin.perm.hasPermission(sender, "suitcase.help")) {
				...
				if (arguments.size() == 2) {
					...
					if (commands.contains(arguments.get(1))) {
						if (plugin.perm.hasPermission(sender, "suitcase." + arguments.get(1)) || (plugin.perm.hasPermission(sender, "suitcase.warn") && arguments.get(1) == "forgive") || plugin.cfg.data.getBoolean("mechanics.full-help")) {
							...
							plugin.con.log(actionType.PLAYER_COMMAND_EXECUTED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase help " + arguments.get(1))));
						}
						else {
							...
							plugin.con.log(actionType.PLAYER_COMMAND_DENIED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase help " + arguments.get(1))));
						}
					}
					else {
						...
						plugin.con.log(actionType.PLAYER_COMMAND_INVALID, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase help " + arguments.get(1))));
					}
				}
				// full command help
					...
					plugin.con.log(actionType.PLAYER_COMMAND_EXECUTED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase help")));
				}
				else {
					// too many arguments
					lines.add(plugin.msg.data.getString("error.argument.count"));
					plugin.con.log(actionType.PLAYER_COMMAND_INVALID, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase " + plugin.msg.getString(arguments, false))));
				}
			}
			else {
				...
				plugin.con.log(actionType.PLAYER_COMMAND_DENIED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase help")));
			}
		}
		// /suitcase info
			...
			if (plugin.perm.hasPermission(sender, "suitcase.info")) {
				if (arguments.size() > 1) {
					...
					plugin.con.log(actionType.PLAYER_COMMAND_EXECUTED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase info")));
				}
			}
			else {
				...
				plugin.con.log(actionType.PLAYER_COMMAND_DENIED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase info")));
			}
		}
				...
				if (plugin.cfg.data.getBoolean("mechanics.rating.enable")) {
					...
					if (arguments.size() == 1) {
						...
						if (sender instanceof Player) {
							...
							lines.add(plugin.msg.parse(plugin.msg.data.getString("rate.rating"), "rating", String.valueOf(plugin.con.getRating(sender.getName())), "/"));
							lines.add(plugin.msg.parse(plugin.msg.data.getString("rate.warnings"), "warnings", String.valueOf(plugin.con.getWarnings(sender.getName())), "/"));
							...
							plugin.con.log(actionType.PLAYER_COMMAND_DENIED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase rate")));
						}
					}
					...
					// one argument -> view rating of someone else
						...
						if (target != null) {
							...
							if (plugin.con.hasRated(target.getName(), sender.getName()) || !(sender instanceof Player)) {
								// send target's rating and warnings and check whether he has rated the player, who executed the command, or not
								lines.add(plugin.msg.parse(plugin.msg.data.getString("rate.header"), "player", target.getName() + "'s", "\\'"));
								lines.add(plugin.msg.parse(plugin.msg.data.getString("rate.rating"), "rating", String.valueOf(plugin.con.getRating(target.getName())), "/"));
								lines.add(plugin.msg.parse(plugin.msg.data.getString("rate.warnings"), "warnings", String.valueOf(plugin.con.getWarnings(target.getName())), "/"));
								plugin.con.log(actionType.PLAYER_COMMAND_EXECUTED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase rate " + target.getName())));
							}
							else {
								// player has to rate targeted player first in order to view his rating
								lines.add(plugin.msg.parse(plugin.msg.data.getString("error.player.rate"), "player", target.getName()));
								plugin.con.log(actionType.PLAYER_COMMAND_DENIED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase rate " + target.getName())));
							}
						}
						else {
							// player doesn't exist
							lines.add(plugin.msg.parse(plugin.msg.data.getString("error.player.name"), "player", arguments.get(1)));
							plugin.con.log(actionType.PLAYER_COMMAND_INVALID, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase rate " + arguments.get(1))));
						}
					}
						...
						if (target != null) {
							try { // catch NumberFormatException
								if (Integer.parseInt(arguments.get(2)) >= 0 && Integer.parseInt(arguments.get(2)) <= plugin.cfg.data.getInt("mechanics.rating.maximum")) {
									plugin.con.setRating(sender.getName(), target.getName(), Integer.parseInt(arguments.get(2)));
									lines.add(plugin.msg.parse(plugin.msg.data.getString("rate.done"), "player", target.getName()));
									plugin.con.log(actionType.PLAYER_COMMAND_EXECUTED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase rate " + target.getName() + " " + arguments.get(2))));
								}
								else {
									// rating not found
									lines.add(plugin.msg.parse(plugin.msg.data.getString("error.argument.rating"), "rating", arguments.get(2)));
									plugin.con.log(actionType.PLAYER_COMMAND_INVALID, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase rate " + target.getName() + " " + arguments.get(2))));
								}
						    }
							...
							// player doesn't exist
							lines.add(plugin.msg.parse(plugin.msg.data.getString("error.player.name"), "player", arguments.get(1)));
							plugin.con.log(actionType.PLAYER_COMMAND_INVALID, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase rate " + arguments.get(1) + " " + arguments.get(2))));
						}
					}
					else {
						// too many arguments
					...
					plugin.con.log(actionType.PLAYER_COMMAND_DENIED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase " + plugin.msg.getString(arguments, false))));
				}
			}
			else {
		...
		// /suitcase warn/forgive [player]
			...
			if (plugin.perm.hasPermission(sender, "suitcase.warn")) {
					...
					if (arguments.size() == 2) {
						...
						if (target != null) {
							if (aliases.get("warn").contains(arguments.get(0))) {
								plugin.con.setWarnings(sender.getName(), target.getName(), true);
								lines.add(plugin.msg.parse(plugin.msg.data.getString("warn.done"), "player", target.getName()));
								plugin.con.log(actionType.PLAYER_COMMAND_EXECUTED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase warn " + target.getName())));
							}
							else { // forgive
								plugin.con.setWarnings(sender.getName(), target.getName(), false);
								lines.add(plugin.msg.parse(plugin.msg.data.getString("forgive.done"), "player", target.getName()));
								plugin.con.log(actionType.PLAYER_COMMAND_EXECUTED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase forgive " + target.getName())));
							}
						}
						else {
							// player doesn't exist
				...
				plugin.con.log(actionType.PLAYER_COMMAND_DENIED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase warn")));
			}
		}
		// /suitcase reload
			...
			if (plugin.perm.hasPermission(sender, "suitcase.reload")) {
				if (arguments.size() > 1) {
					...
					plugin.con.log(actionType.PLAYER_COMMAND_EXECUTED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase reload")));
					plugin.reload();
				...
				plugin.con.log(actionType.PLAYER_COMMAND_DENIED, new ArrayList<String>(Arrays.asList(sender.getName(), "/suitcase reload")));
			}
		}
		// command not found
		else {
