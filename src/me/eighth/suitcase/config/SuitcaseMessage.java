...
public class SuitcaseMessage {
	...
	public void sendInfo(CommandSender sender, String...args) {
		// TODO: provide plugin information and authors
	}
	
	// shows information about current rating
	public void sendRate(CommandSender sender, String...args) {
		
	}
	
	// allows admins to warn players easily
	public void sendWarn(CommandSender sender, String...args) {
		
	}
	
	// returns a message to the player, when this plugin finished reloading
	public void sendReload(CommandSender sender, String...args) {
		
	}
	
	// informs the player about not being allowed to execute that command
	public void sendDeny(CommandSender sender, String...args) {
		
	}

	// sender isn't a player
	public void sendConsole(CommandSender sender, String...args) {
		
	}
	
	// player not found
	public void sendPlayer(CommandSender sender, String...args) {
		
	}
	
	// unknown command
	public void sendUnknown(CommandSender sender, String...args) {
